...
Revision ID: 28810c3b5028
Revises: a5cffa318ac2
Create Date: 2025-06-30 13:18:41.637470
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('image', 'video', 'audio', name='mediatypeenum'), nullable=False),
